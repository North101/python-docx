...
"""
Custom element classes that correspond to the header or footer part, e.g.
<w:hdr> or <w:ftr>.
"""
...
class CT_HeaderFooter(BaseOxmlElement):
    """
    ``<w:hdr>``, the container element for the header
    """
    ...
    def clear_content(self):
        """
        Remove all content child elements from this <w:hdr> or <w:ftr> element. Leave
